...
API_ID = int(environ.get('API_ID', "24274375"))
API_HASH = environ.get('API_HASH', "9d88affc9ab571a6695e069cef5d363b")
BOT_TOKEN = environ.get('BOT_TOKEN', "7963986526:AAHW-8ecZU3oqc5U7kAb9VDD9sw0P2AguO8")
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', "7290811275").split()]
USERNAME = environ.get('USERNAME', "https://t.me/KingofAtttitude") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001770039008'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/CinemaMovie_Group')
...
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/CinemaMovie_Group")
